...
for t in range(N):
    ...
    if t > N_LS:
        ...
        delta_t = np.hstack(build_aligned_hypercube(classical_intersection.current_H[:,-1], theta_t, 2*epsilon[t]))
...
ax[1].plot(volume_classical[N_LS:] / volume_conservative[0], label='Volume  intersection')
ax[1].plot(volume_conservative[N_LS:] / volume_conservative[0], label='Volume  conservative intersection')
ax[1].plot(volume_underapproximate[N_LS:] / volume_conservative[0], label='Volume  underapproximate intersection')
#ax[1].plot(volume_overapproximate[N_LS:] / volume_conservative[0], label='Volume  overapproximate intersection')
#ax[1].plot(volume_theta_hypercube[N_LS:] / volume_conservative[0], label='Volume hypercube around theta')
ax[1].grid()
#ax[1].set_yscale('log')
ax[1].legend()
